...
async def start(client, message):
    if message.chat.type in [enums.ChatType.GROUP, enums.ChatType.SUPERGROUP]:
        buttons = [
            [
                InlineKeyboardButton('🔔 BOT Updates 🤖', url='https://telegram.me/MOVIES_HUB_ALPHA_OFFICIAL')
            ],
            [
                InlineKeyboardButton('⚡ Movie Updates ⚡', url=f"https://telegram.me/MOVIES_HUB_ALPHA_OFFICIAL"),
            ],
            [
    ...
    if len(message.command) != 2:
        buttons = [[
            ...
            InlineKeyboardButton('⚡ Movie Updates ⚡', url=f"https://telegram.me/MOVIES_HUB_ALPHA_OFFICIAL"),
            InlineKeyboardButton('🔔 BOT Updates 🤖', url='https://t.me/MOVIES_HUB_ALPHA_OFFICIAL')
            ],[
    ...
    await client.send_cached_media(
        ...
        file_id=file_id,
        caption=f_caption,
        reply_markup=InlineKeyboardMarkup( [ [InlineKeyboardButton('sᴜʙsᴄʀɪʙᴇ', url='https://t.me/+NH6F7ZBBrO8yMDll')] ] ),
        protect_content=True if pre == 'filep' else False,
        )
